...
const Layout = ({ children, title }) => {
  ...
  return (
    <div>
      <Head>
        <title>{title ? `${title}-Gbese` : "Gbese"} </title>
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              ...
              <Link href="/" passHref>
                <h1 className="text-2xl text-green-500 cursor-pointer font-medium">
                  Gbese
                </h1>
              </Link>
            </div>
            <div className="-mr-2 -my-2 md:hidden">
              <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center  :bg-gray-800 justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500">
             ...
             <Link href="/auth/login" passHref>
              ...
              {!Cookies.get("userInfo") ? (
                <a
                  ...
                  className="ml-8 cursor-pointer whitespace-nowrap inline-flex items-center justify-center px-4 py-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-500 hover:bg-green-400"
                >
                  ...
                  <Popover className="relative">
                    {({ open }) => (
                      <>
                        ...
                        >
                          <div className="relative flex-shrink-0 px-2 text-base font-medium cursor-pointer :text-gray-300 text-gray-500">
                            <h1>{name}</h1>
                          </div>
                        ...
                        >
                          <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-40 max-w-md sm:px-0">
                            <div className="rounded-lg text-center shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              <div className="relative text-center grid gap-2 bg-white :bg-gray-800  py-1 sm:gap-8 sm:p-8">
                                <a
                                  onClick={() => router.push("/newquestion")}
                                  className="-m-3 cursor-pointer text-center  items-start rounded-lg hover:bg-gray-700"
                                >
                                  <p className="text-base text-center cursor-pointer :text-gray-300 text-gray-500">
                                    Ask
                                  </p>
                                </a>
                                <a
                                ...
                                >
                                  <p
                                    style={{ color: "red" }}
                                    className="text-base text-center :text-gray-300 text-red-500"
                                  >
                                    logout
                                  </p>
                                </a>
            ...
            <div className="rounded-lg shadow-lg ring-1  :bg-gray-800 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
              <div className="pt-5 pb-6 px-5">
                <div className="flex items-center justify-between">
                  <div></div>
                  <div className="-mr-2">
                    <Popover.Button className="bg-white  :bg-gray-800 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500">
      ...
      <footer className="flex flex-col items-center justify-between px-6 py-4 bg-white :bg-gray-800 sm:flex-row">
        <a
          href="#"
          className="text-xl font-bold text-gray-800 :text-white hover:text-gray-700 :hover:text-gray-300"
        >
          Brand
        </a>

        <p className="py-2 text-gray-800 :text-white sm:py-0">
          All rights reserved
        </p>
        ...
        <div className="flex -mx-2">
          <a
            href="#"
            className="mx-2 text-gray-600 :text-gray-300 hover:text-gray-500 :hover:text-gray-300"
            aria-label="Reddit"
          >
            <svg
