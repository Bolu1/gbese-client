      ...
      {loading ? (
        ...
        <>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        className="fill-current text-green-400 dark:fill-slate-600"
                      ></path>
                      <path
          ...
          <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            <div className=" z-10 top-0 h-16 bg-white lg:py-2.5">
              <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
                <div className="flex space-x-4">
                  {/* <!--search bar --> */}
                  <p className="mt-5 text-2xl">
                    What's up{" "}
                    <span className="text-green-600 font-bold">{user.fn}</span>{" "}
                    <br />{" "}
            ...
            <div className="px-6 mt-6 pt-6 2xl:container">
              <div className="">
                <div className="flex justify-between p-6 border rounded-lg sm:p-8 dark:bg-coolGray-900 dark:text-coolGray-100">
                  {!refresh ? (
                    <div className="space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                      <p className="text-gray-600 md:ml-6">Total Funds</p>
                  ...
                  <>
                    {refresh ? (
                      <>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-10 w-12 mt-5 md:mt-2 animate-spin cursor-pointer"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth={2}
                      ...
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-10 w-12 mt-5 md:mt-2 cursor-pointer"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={2}
